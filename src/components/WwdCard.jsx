...
function WwdCard() {
  return (
    <>
      <div className="what-we-do-card h-full flex flex-col items-center justify-evenly text-center">
        <div className="wwd-card-image w-3/5 aspect-square relative">
          <img
        ...
        <div className="w-1/2 h-16 bg-sec rounded-full text-white">
